...
import { getETHLotteryInfo } from "../../../../../common/integrations/contracts/EthJs/EthFunctions";
  ...
  useEffect(() => {
    const fetchLottery = async () => {
      ...
      if (props.id == currentLotteryID) {
        ...
        setTotalMoney(parseFloat((lotteryMapping.get(props.id)?.amount || 0).toString()))
      }
      else {
        //@ts-ignore
          ...
          {props.id == currentLotteryID || previousLotteryID ? <>
            <div style={{
              ...
              <div style={{ display: "flex", alignItems: "left", justifyContent: 'left' }}>
                ...
                <span style={{ fontSize: "1.25rem" }}>Pot Raised: {totalMoney.toFixed(2)} wei</span>
              </div>
